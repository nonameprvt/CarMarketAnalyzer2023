...
brands = browser.find_elements(
    By.XPATH, "//span[contains(@data-ftid, 'component_cars-list-item_name')]")

for brand in brands:
    brand_browser = webdriver.Chrome()
    ...
    while True:
        ...
        cars = \
            brand_browser.find_elements(
                By.XPATH, "//a[contains(@class, 'css-xb5nz8')]")
        ...
        for car in cars:
            ...
            try:
                ...
                try:
                    description = current.find_elements(
                        By.XPATH,
                        "//span[contains(@class, 'css-1kb7l9z')]")[1].text
